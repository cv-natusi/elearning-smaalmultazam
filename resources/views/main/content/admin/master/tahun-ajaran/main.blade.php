...
<script>
	var routeDatatable = "{{route('admin.tahunAjaran.main')}}";
	var routeTahunAjaranAdd = "{{route('admin.tahunAjaran.add')}}";
	var routeTahunAjaranDelete = "{{route('admin.tahunAjaran.delete')}}";
