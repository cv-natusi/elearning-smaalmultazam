...
<script>
	var routeDatatable = "{{route('admin.dokumen.main')}}";
	var routeMateriAdd = "{{route('admin.dokumen.add')}}";
	var routeMateriView = "{{route('admin.dokumen.add')}}";
	var routeMateriDelete = "{{route('admin.dokumen.delete')}}";
