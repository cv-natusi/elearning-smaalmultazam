					...
					<div class="row">
						...
						<div class="col-12 col-md-10 mb-3 p-4 bg-light">
							...
							<div class="btn-group areaKolom" role="group" aria-label="Kolom">
								<input type="radio" class="d-none email" name="email" id="email" autocomplete="off" checked readonly>
								<label class="btn btn-outline-primary btn-sm email" for="email">Email *</label>
	...
	function renderPilihan() {
		...
		kolom.forEach(element => {
			...
			$('.btnUpload').click((e) => {
				...
				$.ajax({
					url: '{{route("admin.dataGuru.importSave")}}',
					type: 'POST',
					data: data,
					async: true,
					cache: false,
